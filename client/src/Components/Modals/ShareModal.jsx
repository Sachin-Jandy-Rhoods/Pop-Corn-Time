...
import { FaFacebook, FaTwitter,FaTelegram, FaWhatsapp, FaPinterest } from "react-icons/fa";
        ...
        <form className="flex-rows flex-wrap gap-6 mt-6">
            {
                shareData.map((data, index) => (
                    <data.shareButton key={index} url={url} quote="Popcorn Time | Free Movies Site">
